...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> 01739867149</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> ferdous.black420@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{URL::to('')}}"><i class="fa fa-lock"></i> Logout</a></li>
                            <?php }else{?>
    ...
    <script src="{{asset('frontend/js/main.js{{URL::to('frontend/"></script>
</body>
</html>